...
class FareController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        // jobテーブルとuserテーブルを結合
        $fares = Fare::join('users', 'fares.user_id', '=', 'users.id')
            ->select('fares.*', 'users.name_last', 'users.name_first', 'users.email', 'departments.name as department')
    ...
    public function search(Request $request): View
    {
        ...
        //dd($request->history_date, $year, $month);
        //dd(explode('-', $request->history_date));
    ...
    public function edit(Request $request): View
    {
        ...
        $user = Fare::find($request->id)->user;
    ...
    public function update(EditJobRequest $request, $id)
    {
        ...
        if ($user->department_id === TOKYO_DEPARTMENT_ID) { // 東京スタッフの場合
            ...
            $Job->all_payment = $form_data['base_salary'] + $form_data['overtime_charge'] +
                $form_data['nomination_fee'] +  $form_data['traffic_expenses'] ?? 0;
        } else { // 大阪スタッフの場合
            ...
            $Job->all_payment = $form_data['base_salary'] + $form_data['osaka_deemed_overtime_pay'] +
                $form_data['osaka_special_allowance'] + $form_data['osaka_other_allowances'] + $form_data['osaka_traffic_expenses'] ?? 0;
        }

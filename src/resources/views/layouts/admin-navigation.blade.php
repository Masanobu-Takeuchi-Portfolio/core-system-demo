<nav x-data="{ open: false }" class="bg-white border-b border-gray-200">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.userinfo.index')"
                        :active="request()->route()->named('admin.userinfo*')">
                        {{ __('ユーザー管理') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.job.index')"
                        :active="request()->route()->named('admin.job*')">
                        {{ __('勤怠管理') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.fare.index')"
                        :active="request()->route()->named('admin.fare*')">
                        {{ __('交通費管理') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.item.index')"
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.job.index')"
                :active="request()->route()->named('admin.job*')">
                {{ __('勤怠管理') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.dashboard')">

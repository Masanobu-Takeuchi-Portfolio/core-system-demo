<x-app-layout>
    <x-slot name="header">
        <div class="flex mdmax:flex-col items-center justify-between">
            ...
            <form method="get" action="{{ route('user.item.index') }}">
                @csrf
                <div class="flex">
                    <select name="year" id="" class="rounded">
                        @for ($i = $ITEM_START_YEAR; $i <= $ITEM_END_YEAR; $i++)
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-2 text-gray-900">
                    ...
                    <form class="mb-8" method="post"
                        ...
                        {{-- フォーマットここまで --}}
                        <button id="item-add-field-btn" type="button" class="bg-amber-100 p-1">+入力項目を追加する</button>
